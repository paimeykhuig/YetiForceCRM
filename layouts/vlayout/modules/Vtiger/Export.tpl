				...
				<div class="well exportContents marginLeftZero">
					<fieldset>
						...
						<div class="row">
							...
							{*//*** import*}
							<div class="row" style="height:30px">
								{if $export_to_xml_available}
									<div class="col-md-6 textAlignRight row">
										<div class="col-md-8">{vtranslate('LBL_EXPORT_TYPE',$MODULE)}&nbsp;</div>
										<div class="col-md-3">
											<select name="export_type">
												<option value="">CVS</option>
							...
							{if $export_to_xml_available}
							<div class="row hide xml-tpl" style="height:30px">
								<div class="col-md-6 textAlignRight row">
									<div class="col-md-8">{vtranslate('LBL_XML_EXPORT_TPL',$MODULE)}&nbsp;</div>
									<div class="col-md-3">
										<select name="xml_export_type">
